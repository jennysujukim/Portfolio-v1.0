<header class="header">
    ...
    <div class="header-logo">
        <a href="<?php echo get_url('index.php');?>">
            <svg id="primary-logo" viewBox="0 0 474.03 289.46">
                <g id="primary-logo-layer1">
                    <path d="M94.93,86.23c0,2.95-.05,5.85-.14,8.71-.09,2.86-.32,5.3-.69,7.32-1.11,6.82-3.87,11.98-8.29,15.48-4.42,3.5-9.49,5.9-15.2,7.19-5.71,1.29-11.33,2.12-16.86,2.49-7.19,.37-13.45,.5-18.79,.41-5.35-.09-10.64-.37-15.89-.83-5.25-.46-12.06-.97-19.06-1.52v-35.93c2.58,.92,6.95,1.98,11.74,3.18,4.79,1.2,8.75,1.8,11.88,1.8,3.32,0,5.53-1.11,6.63-3.32,1.11-2.21,1.66-4.7,1.66-7.46V0h42.56c7.18,0,12.2,.83,15.06,2.49,2.85,1.66,4.47,4.15,4.84,7.46,.37,3.32,.55,7.46,.55,12.44v63.84Z"/>
                    <path d="M117.65,127.13V18.52c0-7.74,1.38-12.76,4.15-15.06,2.76-2.3,8.2-3.45,16.31-3.45h140.67V32.06h-98.11v15.2h88.44v31.78h-88.44v16.03h98.11v32.06H117.65Z"/>
                    <path d="M300.74,127.13V18.52c0-7.37,1.24-12.3,3.73-14.79s8.24-3.73,17.27-3.73h60.53l44.22,63.57,1.94,10.78V0h45.6c-.37,.37-.65,1.8-.83,4.28-.18,2.49-.28,5.25-.28,8.29V111.65c0,7.01-1.8,11.33-5.39,12.99-3.59,1.66-9.91,2.49-18.93,2.49h-54.72l-46.43-66.33-1.93-10.78V127.13h-44.77Z"/>
                    ...
                    <path d="M196.84,283.48v-108.89c0-3.87,.32-7.19,.97-9.95,.64-2.76,2.39-4.84,5.25-6.22,2.85-1.38,7.6-2.07,14.23-2.07h42.56v127.13h-63.01Z"/>
    ...
    <div class="nav-container">
        <nav class="nav">
            <div class="nav-close">
                <svg class="nav-close-arrow" width="40" height="41" viewBox="0 0 40 41">
                    <path class="nav-close-arrow-path" d="M19 1L38 20.5L19 40"/>
                    <path class="nav-close-arrow-path"  d="M0 21L38 21"/>
                </svg>
            </div>
            <ul>
                <li><a href="<?php echo get_url('index.php');?>">Home</a></li>
                <li><a href="<?php echo get_url('about.php');?>">About</a></li>
                <li>
                    <a href="<?php echo get_url('projects/index.php');?>">Projects</a>
                    <div class="projects-sub is-flex">
                        <a href="<?php echo get_url('projects/index.php');?>">All</a>
                        <a href="<?php echo get_url('projects/design.php');?>">Design</a>
                        <a href="<?php echo get_url('projects/develop.php');?>">Develop</a>
                    </div>
                </li>
            </ul>
        </nav>
