<?php
    ...
    $title_tag = "Design Projects | Jenny Seojeong Kim | Front-end Developer";
        ...
        <div class="discipline-wrapper">
            <section class="container discipline-title is-flex">
                ...
                <div class="discipline-title-filter">
                    ...
                    <a href="<?php echo get_url('projects/design.php');?>" class="button <?php echo $button_anim === "none" ? "button-anim" : "current";?> is-flex">
                        Design
                        <img class="button-arrow" src="<?php echo get_url('images/flower.png');?>">
                    </a>
                    <a href="<?php echo get_url('projects/develop.php');?>" class="button <?php echo $button_anim === "active" ? "button-anim" : "current";?> is-flex">
                        Develop
                        <img class="button-arrow" src="<?php echo get_url('images/flower.png');?>">
                    </a>
                </div>
            ...
            <section class="discipline-project is-flex">
                <ul class="project-list">
                    <?php foreach($designs as $project){include(get_project_path('partials/projects/projects-list.php'));}; ?>                    
                </ul>
            </section>
        <div>  
    </main>
