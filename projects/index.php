<?php
    ...
    $title_tag = "All Projects | Jenny Seojeong Kim | Front-end Developer";
        ...
        <div class="discipline-wrapper">
            <section class="container discipline-title is-flex">
                ...
                <div class="discipline-title-filter">
                    <a href="<?php echo get_url('projects/index.php');?>" class="button <?php echo $button_anim === "none" ? "button-anim" : "current";?> is-flex">
                        All
            ...
            <section class="discipline-project is-flex">
                <ul class="project-list">
                    <?php foreach($projects as $project){include(get_project_path('partials/projects/projects-list.php'));}; ?>                    
                </ul>
            </section>
        <div>  
    </main>
